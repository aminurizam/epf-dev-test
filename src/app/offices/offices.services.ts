...
export class OfficesServices {
  // same as this.http = new HttpClient()
  constructor(private http: HttpClient) {}

  url: string = 'https://secure.kwsp.gov.my/m2/postBranchLocation';

  getOffices() {
    // have issue with CORS header; Cross-Origin Request Blocked: The Same Origin Policy disallows reading the remote resource at https://secure.kwsp.gov.my/m2/postBranchLocation. (Reason: CORS header ‘Access-Control-Allow-Origin’ missing).
    /* this.http
      .post<any>(this.url, { ios: '100', lan: 'EN', ver: '100' })
      .subscribe((data) => {
        console.log(data);
      }); */

    // use below as temporary solution to simulate fetching data
    return {
      sta: '0000',
      ver: '20201205210112',
      lis: [
